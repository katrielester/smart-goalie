...
smart_training_flow = {
    ...
    "how_often": {
        ...
        "next": {"Often": "smart_intro", "Sometimes": "smart_intro", "Never": "smart_intro"}
    },
    "smart_intro": {
        "text": [
    ...
    "smart_definition": {
        "text": [
            ...
            "Watch this video to learn more about SMART goals:\n\n[Achieve More by Setting SMART Goals (YouTube)](https://www.youtube.com/watch?v=yA53yhiOe04&ab_channel=FlikliTV)"
        ],
        "buttons": ["I watched the video"],
        "next": {"I watched the video": "specific_intro"}
    },
    "specific_intro": {
        "text": [
